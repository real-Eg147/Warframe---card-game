namespace WEffects
{
    ...
    public class Round : Weapon
    {
        ...
        public void Attack(List<Factions> factions, List<Weapon> weapon)
        {
            ...
            while (counter < weapon[0].Shot)
            {
                ...
                // **** ARMATURA ****
                #endregion slot1
                newDamage = weapon[0].CalculateDamage(factions);
                //factions[0].Health -= newDamage;
